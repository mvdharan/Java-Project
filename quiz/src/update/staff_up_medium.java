...
/**
 * Servlet implementation class staff_up_medium
 */
@WebServlet("/staff_up_medium")
public class staff_up_medium extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public staff_up_medium() {
        super();
		 ...
		 try
		    {
		      ...
		      String query = "update easy set qustions = ? where id = "+id+"";
		      String query1 = "update easy set QA = ? where id = "+id+"";
		      String query2 = "update easy set QB = ? where id = "+id+"";
		      String query3 = "update easy set QC = ? where id = "+id+"";
		      String query4 = "update easy set QD = ? where id = "+id+"";
		      String query5 = "update easy set answer = ? where id = "+id+"";
