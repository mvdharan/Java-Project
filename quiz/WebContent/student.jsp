...
<a href="index.jsp"  >back</a>&nbsp
<form action="Student_login" method="post">
<br><br><br><br><br><br>
<p style="text-align:center">STUDENT LOGIN</p>
  <p style="text-align:center"> Enter username :<input type="text" name="username"> <br><br>
    Enter password :<input type="password" name="password"><br>

   <br> <input type="submit" value="Login">
   <input type="reset" value="cancel">
      <p style="text-align:center">  <a href="student_reg.jsp">register here</a></p>
