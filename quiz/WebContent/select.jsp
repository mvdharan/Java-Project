...
<p style="text-align:center;  color: white; size:20 " >WELCOME <%String name = (String)request.getAttribute("myname"); %>
<%= name%>!!!</p>
 <%String id = (String)request.getAttribute("id"); %>
<br><br><br><br><p style="text-align:center"><br>

 <a href="easy.jsp?name=<%=name%>&id=<%=id%>&q=1">EASY</a>

<br><br><br>


<a href="medium.jsp?name=<%=name%>&id=<%=id%>&q=2"  >MEDIUM</a><br><br>
<br>
 <a href="hard.jsp?name=<%=name%>&id=<%=id%>&q=3">HARD</a>
</body>
</html>