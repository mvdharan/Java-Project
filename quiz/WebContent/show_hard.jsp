...
<a href="update_hard.jsp"  >back</a>&nbsp
...
while(rs.next()){
%>
<tr><td><%=i%>&nbsp :&nbsp<%=rs.getString("qustions")%></td></tr><tr><td><input type="radio" value="<%=rs.getString("QA")%>" name="radio<%=i%>"/><%=rs.getString("QA")%></td></tr><td><input type="radio" value="<%=rs.getString("QB")%>" name="radio<%=i%>"/><%=rs.getString("QB")%></td></tr><td><input type="radio" value="<%=rs.getString("QC")%>" name="radio<%=i%>"/><%=rs.getString("QC")%></td></tr><td><input type="radio" value="<%=rs.getString("QD")%>" name="radio<%=i%>"/><%=rs.getString("QD")%></td></tr><td><a href="update_hardq.jsp?id=<%=rs.getString("id")%>">UPDATE</a></td></tr>
