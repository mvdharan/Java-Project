...
<a href="student.jsp"  >back</a>&nbsp
<form action="Student_reg" method="post">  
  <p style="text-align:center"> 
  <br/><br/><br/><br/><br/>
&nbsp&nbsp&nbsp&nbsp Name:<input type="text" name="userName"/><br/><br/>  
Password:<input type="password" name="userPass"/><br/><br/>  
&nbspEmail Id:<input type="text" name="userEmail"/><br/><br/>  
<br/>
&nbsp&nbsp&nbsp&nbsp<input type="submit" value="register"/> 
<input type="reset" value="cancel"/><br/> <br/>
  <p style="text-align:center">  &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<a href="student.jsp">&nbsp&nbsp&nbspgo to login page&nbsp&nbsp&nbsp</a></p>
</form>  
</body>  
</html> 